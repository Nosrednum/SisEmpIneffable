sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.ineffableErrorsList.controller.ErrosListCo", {
		...
		_onButtonPress: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				this.doNavigate("EmpresasList", oBindingContext, fnResolve, "");
		...
		createFiltersAndSorters: function () {
			...
			aPropertyFilters.push(new sap.ui.model.Filter("associatedApp", "EQ", "Concilium"));
			oBindingData.filters.push(new sap.ui.model.Filter(aPropertyFilters, false));

			this.updateBindingOptions(
				"sap_List_Page_0-im2v9q0dxhihwkgvw7d0gio93_S3-content-sap_m_ObjectList-1607661287876-q1quch6v0c7nmu0d8p0207qo4_S4", oBindingData);
		...
		onInit: function () {
			...
			this.oRouter.getTarget("ErrosListCo").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			this.mAggregationBindingOptions = {};
			this.createFiltersAndSorters();

			this.applyFiltersAndSorters(
				"sap_List_Page_0-im2v9q0dxhihwkgvw7d0gio93_S3-content-sap_m_ObjectList-1607661287876-q1quch6v0c7nmu0d8p0207qo4_S4", "items");
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-im2v9q0dxhihwkgvw7d0gio93_S3-content-sap_m_ObjectList-1607661287876-q1quch6v0c7nmu0d8p0207qo4_S4",
				"groups": ["items"]
			}];
