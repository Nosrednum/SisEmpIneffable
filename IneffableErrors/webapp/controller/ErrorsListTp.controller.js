sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.ineffableErrorsList.controller.ErrorsListTp", {
		...
		createFiltersAndSorters: function () {
			...
			aPropertyFilters.push(new sap.ui.model.Filter("associatedApp", "EQ", "Transplaneta"));
			oBindingData.filters.push(new sap.ui.model.Filter(aPropertyFilters, false));

			this.updateBindingOptions("sap_List_Page_0-content-sap_m_ObjectList-1527500729638", oBindingData);
		...
		onInit: function () {
			...
			this.oRouter.getTarget("ErrorsListTp").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			this.mAggregationBindingOptions = {};
			this.createFiltersAndSorters();

			this.applyFiltersAndSorters("sap_List_Page_0-content-sap_m_ObjectList-1527500729638", "items");
