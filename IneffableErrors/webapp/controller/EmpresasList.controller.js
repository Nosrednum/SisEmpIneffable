sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.ineffableErrorsList.controller.EmpresasList", {
		...
		_onButtonPress1: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				this.doNavigate("ErrorsListEp", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function (err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onButtonPress2: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				this.doNavigate("ErrosListCo", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function (err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function () {
			...
			this.oRouter.getTarget("EmpresasList").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
